...
export const AppConfig = {
  ...
  api: {
    ...
    get multiplayer() {
      return (
        process.env.MULTIPLAYER_SERVER_URL || `wss://multiplayer.${AppConfig.domain.production}`
      );
    },
    get admin() {
  ...
  firebase: {
    ...
    storageBucket:
      process.env.FIREBASE_STORAGE_BUCKET || 'potofgold-production.firebasestorage.app',
