...
class AppRatingManager {
  ...
  private async showRatingPrompt(
    context: 'achievement' | 'milestone' | 'general'
  ): Promise<boolean> {
    const messages = {
      achievement: {
        title: '🎉 Awesome Achievement!',
        message:
          "You're doing great! Would you mind rating Pot of Gold to help other players discover this game?",
        positive: 'Rate Now',
      ...
      milestone: {
        ...
        message:
          "You've reached an amazing milestone! If you're enjoying Pot of Gold, would you consider leaving a review?",
