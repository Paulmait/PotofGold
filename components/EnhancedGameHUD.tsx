  ...
  const loadUserProgress = async () => {
    try {
      ...
      if (seasonData.currentSeason) {
        ...
        const progress = (seasonData.currentSeason.experience / 
                         seasonData.currentSeason.experienceToNext) * 100;
  ...
  return (
    <View style={[styles.container, { padding: ss(6) }]}>
      ...
      <View style={styles.middleRow}>
        ...
        >
          ...
          <View style={styles.streakInfo}>
            ...
            <Text style={[styles.streakNumber, { fontSize: sf(12) }]}>
              {dailyStreak} DAYS
            </Text>
          </View>
        </TouchableOpacity>
        ...
        <View style={styles.levelContainer}>
          ...
          <Text style={[styles.levelNumber, { fontSize: sf(16) }]}>
            {level}
          </Text>
        </View>
        ...
        >
          ...
          <View style={styles.seasonInfo}>
            <Text style={[styles.seasonLabel, { fontSize: sf(9) }]}>
              TIER {seasonPassTier}
            </Text>
      ...
      <View style={styles.bottomRow}>
        ...
        {__DEV__ && fps && (
          <Text style={[styles.fpsText, { fontSize: sf(9) }]}>
            FPS: {fps}
          </Text>
        )}
      </View>
