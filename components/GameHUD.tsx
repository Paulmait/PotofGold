  ...
  return (
    <View style={styles.hudContainer}>
      ...
      <View style={styles.cartInfoBar}>
        <LinearGradient
          colors={getCartTierColors(cartTier)}
          style={styles.cartInfoGradient}
        >
...
const getCartTierColors = (tier: string): string[] => {
  switch (tier) {
    ...
    case 'diamond': return ['#B9F2FF', '#00FFFF'];
    case 'legendary': return ['#FF00FF', '#FFD700'];
    case 'cosmic': return ['#000000', '#FF00FF'];
    default: return ['#8B4513', '#696969'];
  }
};
