# App Preview Video Storyboard (30 seconds max)
...
### Scene 2: Gameplay (5s)
- **Description**: Player catching coins with pot
- **Key Message**: Show core gameplay/feature
- **Transition**: Smooth fade/slide to next scene

### Scene 3: Power-up (3s)
- **Description**: Magnet power-up attracting coins
- **Key Message**: Show core gameplay/feature
- **Transition**: Smooth fade/slide to next scene

### Scene 4: Shop (3s)
- **Description**: Browsing and unlocking new skins
- **Key Message**: Show core gameplay/feature
- **Transition**: Smooth fade/slide to next scene

### Scene 5: Leaderboard (2s)
- **Description**: High score celebration
- **Key Message**: Show core gameplay/feature
- **Transition**: Smooth fade/slide to next scene

### Scene 6: Call to Action (2s)
- **Description**: Download now text with app icon
- **Key Message**: Show core gameplay/feature
- **Transition**: Smooth fade/slide to next scene
