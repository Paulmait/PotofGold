  ...
  return (
    <View style={[styles.hudContainer, { padding: ss(8) }]}>
      <View style={styles.hudRow}>
        ...
        <Text style={[styles.hudText, { fontSize: sf(14) }]}>
      ...
      {__DEV__ && <Text style={[styles.fpsText, { fontSize: sf(10) }]}>FPS: {fps}</Text>}
    </View>
  );
});

const GameScreenClean: React.FC<GameScreenCleanProps> = memo(({ navigation, route }) => {
      ...
      >
        <View style={styles.container}>
          ...
          <View style={styles.gameArea}>
            ...
            >
              <MineCart position={0} size={cartSize} isTurboActive={false} activeSkin={null} />
            </Animated.View>
            ...
            <BlockageVisual
              ...
              onClearPress={() => {
                if (coins >= 50) {
                  ...
                  setFallingItems((prev) => prev.filter((item) => item.y < height - 200));
                }
              }}
          ...
          {!isGameActive && !showGameOver && !autoStart && (
            <View style={styles.startOverlay}>
              <TouchableOpacity style={styles.startButton} onPress={startGame}>
                <Text style={[styles.startButtonText, { fontSize: sf(24) }]}>Tap to Start</Text>
          ...
          {showGameOver && (
            <View style={styles.gameOverOverlay}>
              <View style={styles.gameOverCard}>
                <Text style={[styles.gameOverTitle, { fontSize: sf(32) }]}>Game Over</Text>
                ...
                <View style={styles.gameOverButtons}>
                  ...
                  >
                    <Text style={[styles.gameOverButtonText, { fontSize: sf(18) }]}>Home</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
            ...
            <GameBottomBar
              ...
              onVacuumPress={() => {
                if (coins >= 25) {
                  ...
                  setFallingItems((prev) => prev.map((item) => ({ ...item, collected: true })));
                  setBlockages(0);
                }
              }}
              onClearAllPress={() => {
